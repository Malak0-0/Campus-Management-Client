...
export const addCampusThunk = (campus) => async (dispatch) => {
  try {
    ...
    dispatch(ac.addCampus(res.data)); // Correct
    return res.data; // Return the new campus for redirect
  } catch (err) {
    console.error(err);
  }
};
...
export const editCampusThunk = (campus) => async (dispatch) => {
  try {
    ...
    dispatch(ac.editCampus(res.data)); // Fix: Use res.data
  } catch (err) {
    console.error(err);
  }
};
...
export const deleteCampusThunk = (campusId) => async (dispatch) => {
  try {
    ...
    dispatch(ac.deleteCampus(campusId)); // Correct
  } catch (err) {
    console.error(err);
  }
};
